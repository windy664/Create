...
public class FlwConfigScreen extends BaseConfigScreen {
	...
	protected void init() {
		...
		TextStencilElement clientText = new TextStencilElement(minecraft.font, new TextComponent(clientTitle)).centered(true, true);
		...
		TextStencilElement commonText = new TextStencilElement(minecraft.font, new TextComponent(commonTitle)).centered(true, true);
		...
		TextStencilElement serverText = new TextStencilElement(minecraft.font, new TextComponent(serverTitle)).centered(true, true);
